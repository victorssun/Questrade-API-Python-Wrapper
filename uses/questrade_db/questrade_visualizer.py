...
### MAIN ###
if os.name == 'nt':
    investment_directory = 'C:/Users/A/Documents/K/Ongoing Projects/Investments/'
elif os.name == 'posix':
    investment_directory = '/mnt/a_drive/investments/'

# set up
path_db = '{}Questrade_Wrapper/uses/questrade_db/questrade.db'.format(investment_directory)
